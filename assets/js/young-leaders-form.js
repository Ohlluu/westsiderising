// ===================================
// WR YOUNG LEADERS POWER ACADEMY APPLICATION FORM HANDLER
// ===================================
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        const formData = {
            formType: 'Young Leaders Power Academy Application',
        ...
        try {
            await addDoc(collection(db, 'youngLeadersApplications'), formData);
        ...
        <div style="max-width:680px;margin:4rem auto;padding:0 1.5rem;font-family:'Source Sans Pro',sans-serif;">
            ...
            <div style="background:#fff8f8;border-radius:16px;border:1px solid #ffd0d0;padding:2rem;margin-bottom:1rem;">
                <div style="display:flex;align-items:flex-start;gap:1.25rem;">
                    ...
                    <div>
                        <h3 style="font-family:'Playfair Display',serif;font-size:1.25rem;font-weight:700;color:#1a1a1a;margin:0 0 0.6rem;">One More Step — Take Your Assessment</h3>
